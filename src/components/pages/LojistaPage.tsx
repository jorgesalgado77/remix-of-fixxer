        ...
        <TooltipProvider>
          <nav className="flex flex-col gap-2">
              ...
              <SidebarButton 
                ...
                label="Favoritos" 
                active={false} 
                onClick={() => navigate({ to: '/favoritos' as any }).catch(() => { window.location.href = '/favoritos'; })} 
              />
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4">
                {/* ─── Card "MEU PLANO & SALDO DE MOEDAS" (Passo 7) ─── */}
                <div className="col-span-2 md:col-span-3 lg:col-span-5 bg-[#1A1A1B] border border-white/10 p-4 md:p-6 rounded-2xl md:rounded-3xl relative overflow-hidden group hover:border-amber-400/40 transition-all">
                                                    ...
                                                    <div className="flex flex-col gap-3 justify-end items-end w-full">
                                                        <div className="w-full p-3 rounded-xl bg-white/5 border border-white/5">
                                                            ...
                                                            <div className="flex flex-wrap gap-2 w-full">
                                                                <Link 
                                                                    to="/feed/lojista" search={{ q: service.id }}
