    ...
    <div ref={panelRef} className="relative">
      ...
      {open && (
        <div
          ...
          className="absolute right-0 mt-2 w-[320px] max-h-[70vh] overflow-hidden rounded-2xl bg-black/95 backdrop-blur-xl border border-white/15 shadow-2xl z-[200] flex flex-col"
        >
