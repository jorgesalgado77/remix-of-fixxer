...
type TabId = "planos" | "acoes" | "pacotes";
...
function AdminMonetizacaoPage() {
  ...
  const handleSave = async () => {
    ...
    if (res.remote) {
      ...
      toast.warning("Salvo localmente. Supabase indisponível — verifique a tabela system_settings.", {
    ...
    >
        ...
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[11px] text-gray-400 truncate">
              Planos, custos em moedas e pacotes — salvo em <code className="text-emerald-400">system_settings</code>
            </p>
          </div>
      ...
      <main className="max-w-5xl mx-auto px-4 py-6 space-y-4">
        ...
        {tab === "pacotes" && (
          <PacksEditor
            packs={cfg.coinPacks}
            onChange={(coinPacks) => update({ coinPacks })}
          />
        )}
      </main>
