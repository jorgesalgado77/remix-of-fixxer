      ...
      <header className="relative flex-1 flex flex-col items-center justify-center px-6 py-12 text-center overflow-hidden">
        ...
        <div className="max-w-md mx-auto animate-in fade-in zoom-in duration-700">
          ...
          <div className="flex flex-col gap-4 w-full">
            ...
            <div id="ts-visual-edit-probe-23b5de639a0a49cb" className="text-xs text-muted-foreground/40 mb-2 italic">
              Adicionar suporte a VITE_SUPABASE_URL e VITE_SUPABASE_ANON_KEY via variáveis de ambiente e um fallback/validação no build para evitar o erro "supabaseUrl is required".
            </div>
            <button 
