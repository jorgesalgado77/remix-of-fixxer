...
const MOCK_JOBS: JobPost[] = [
  ...
  // ============ NOVAS PROPOSTAS (adicionadas) ============
  {
    ...
    requirements: ["Equipe própria mínima 2 pessoas", "Ferramenta profissional", "Emissão de nota"],
  ...
  },
  {
    ...
    requirements: ["Furação em alvenaria", "Ajuste fino de nichos", "Limpeza pós-obra"],
  ...
  },
  {
    ...
    requirements: ["Disponibilidade imediata", "Experiência alto padrão", "Relatório com fotos"],
  ...
  },
  {
    ...
    requirements: ["Fixação nivelada", "Passagem de fios", "Retirar embalagens"],
  ...
  },
  {
    ...
    requirements: ["Portfolio comprovado", "Domínio Promob", "Prazo máx 5 dias por projeto"],
