...
export const MOCK_CONVERSATIONS: MockConversation[] = [
  {
    peerId: "mock-mariana-guarda-roupa",
    peerName: "Mariana Souza",
    peerRole: "cliente",
    peerAvatar: IMG("photo-1494790108377-be9c29b29330", 200),
    online: true,
    linkedAd: {
      title: "Montagem Urgente de Guarda-Roupa Casal 6 Portas",
    ...
    messages: [
      { id: "m1", fromMe: false, minutesAgo: 90, content: "Oi! Preciso montar um guarda-roupa 6 portas hoje se possível 🙏" },
      { id: "m2", fromMe: false, minutesAgo: 89, content: "Está tudo desmontado no quarto, chegou ontem.", attachment: { url: IMG("photo-1505691938895-1758d7feb511", 1200), type: "image/jpeg", name: "quarto-guarda-roupa.jpg" } },
      { id: "m3", fromMe: true, minutesAgo: 30, content: "Olá, Mariana! Consigo passar hoje à tarde. Fecha na faixa de R$ 320?" },
    ],
    profile: {
      bio: "Cliente Final — reformando o apartamento novo em Sorocaba.",
      ...
      specialties: ["Montagem Residencial"],
      reviews: [],
    },
  },
  {
    peerId: "mock-eletrotech-lojista",
    peerName: "EletroTech Soluções",
    peerRole: "lojista",
    peerAvatar: IMG("photo-1581092160607-ee22621dd758", 200),
    online: false,
    linkedAd: {
      title: "Kit Furadeira e Parafusadeira Bosch 12V",
      category: "Anúncio Comercial",
      distanceKm: 1.8,
      price: 380,
    },
    messages: [
      { id: "m1", fromMe: true, minutesAgo: 240, content: "Bom dia! O kit Bosch 12V ainda tem em estoque?" },
      { id: "m2", fromMe: false, minutesAgo: 235, content: "Bom dia! Sim, temos 6 unidades. R$ 380 à vista." },
      { id: "m3", fromMe: false, minutesAgo: 234, content: "Segue foto do kit lacrado:", attachment: { url: IMG("photo-1572981779307-38b8cabb2407", 1200), type: "image/jpeg", name: "bosch-12v.jpg" } },
      { id: "m4", fromMe: true, minutesAgo: 15, content: "Perfeito, passo aí ainda hoje para buscar." },
    ],
    profile: {
      companyName: "EletroTech Soluções",
      bio: "Loja parceira FIXXER — ferramentas, elétrica e ferragens para o profissional.",
      city: "Sorocaba", state: "SP", whatsapp: "15991230010",
      bannerUrl: IMG("photo-1581092160607-ee22621dd758", 1400),
      gallery: [IMG("photo-1572981779307-38b8cabb2407"), IMG("photo-1581091012184-7c1abfa4116e")],
      activityBranch: "Lojista de Ferramentas",
      rating: 4.8, reviewsCount: 156, yearsActive: 9,
      memberSince: "2016-04-20T00:00:00Z",
      specialties: ["Ferramentas Elétricas", "Ferragens", "Fixação"],
      reviews: [],
    },
  },
  {
    peerId: "mock-carlos-reformas",
    peerName: "Carlos Reformas",
    peerRole: "prestador",
    peerAvatar: IMG("photo-1560250097-0b93528c311a", 200),
    online: true,
    linkedAd: {
      title: "Instalação de Porcelanato 80x80 na Sala",
      category: "Solicitação de Serviço",
      distanceKm: 8.5,
      price: 1200,
    },
    messages: [
      { id: "m1", fromMe: false, minutesAgo: 300, content: "Vi sua solicitação de porcelanato 80x80, tenho experiência com essa medida." },
      { id: "m2", fromMe: false, minutesAgo: 298, content: "Trabalho recente:", attachment: { url: IMG("photo-1600585154340-be6161a56a0c", 1200), type: "image/jpeg", name: "porcelanato-sala.jpg" } },
      { id: "m3", fromMe: true, minutesAgo: 60, content: "Excelente! Fecha em R$ 1.200 com rejunte incluso?" },
      { id: "m4", fromMe: false, minutesAgo: 20, content: "Fecho sim. Posso começar 2ª feira pela manhã." },
    ],
    profile: {
      bio: "Prestador FIXXER — reformas residenciais leves, porcelanato, gesso e pintura.",
      city: "Sorocaba", state: "SP", whatsapp: "15997770020",
      bannerUrl: IMG("photo-1600585154340-be6161a56a0c", 1400),
      gallery: [IMG("photo-1600585154340-be6161a56a0c"), IMG("photo-1600607687644-c7171b42498f")],
      activityBranch: "Reformas Residenciais",
      rating: 4.9, reviewsCount: 88, yearsActive: 6,
      memberSince: "2019-09-10T00:00:00Z",
      specialties: ["Porcelanato", "Gesso", "Pintura"],
      reviews: [],
    },
  },
  {
