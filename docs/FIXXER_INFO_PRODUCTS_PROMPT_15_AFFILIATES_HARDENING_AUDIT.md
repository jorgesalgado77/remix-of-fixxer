...
- [x] Proteção contra Self-Referral ativada por padrão.
- [x] Atribuição idempotente integrada ao Webhook ASAAS (`src/routes/api/public/asaas.ts`).
- [x] Persistência de attribution via metadata do pagamento.

### 3. UI & Analytics
- [x] Dashboard Admin Master expandido com Auditoria de Eventos.
